...
export const metadata = {
  ...
  description: "Hydrate a public GitHub repo into a playable card — tree display, safe live-site redirect, inline media, stub runtimes.",
};
      ...
      <div className="max-w-7xl w-full mx-auto px-8 py-16 flex flex-col gap-12">
        <header className="flex flex-col gap-4">
          ...
          <p className="text-zinc-400 max-w-xl">
            ...
            Live sites open in a new tab, media plays inline. Node in-tab and hosted venv are the next pipes.
          </p>
        </header>
