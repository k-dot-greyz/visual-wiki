...
- **Playground** (`/play`) — hydrate a public GitHub repo into a playable card (tree + link-out or native HTML5 player). Third-party pages are never framed; Node in-tab and hosted venv are stubbed.
